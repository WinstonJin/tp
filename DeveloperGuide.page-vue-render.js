...
with(this){return _c('p',[_v("The pagination makes use of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("javafx.scene.control.Pagination")]),_v(" component which is inherited by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PaginationPanel")]),_v(". The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PaginationPanel.java")]),_v(" stores all logic\nand attributes related to Pagination.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Since the constructor adds a listener that listens to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("onListItemsChanged")]),_v(" event on "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("personList")]),_v(". The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("onListItemsChanged")]),_v(" simply invokes\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("initPagination")]),_v(" to re-render the list displayed. It takes the following steps to make the update:")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("1a. User did not provide the search input\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 5 Nov 2024, 12:54:51 GMT+8]")])])])}
}];
