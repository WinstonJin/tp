...
Examples:
*  `edit 1 th/john_doe123 e/johndoe@example.com` Edits the phone number and email address of the 1st person to be `john_doe123` and `johndoe@example.com` respectively.
