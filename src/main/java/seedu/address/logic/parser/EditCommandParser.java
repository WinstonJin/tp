...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        parseNicknameForEdit(argMultimap.getValue(PREFIX_NICKNAME).get()).ifPresent(editPersonDescriptor::setNickname);
        parseTagsForEdit(argMultimap.getAllValues(PREFIX_ROLE)).ifPresent(editPersonDescriptor::setRoles);
